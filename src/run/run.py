...
def run(_run, _config, _log):
    ...
    name1=args.name+'_base_G_s_input_hi_w_Ni_grad_to_hi_2_7_13_abs_Gs_sigmoid'+'_sd_alpha='+str(args.sd_alpha)+'_transformer_4'+'_map_' + args.env_args['map_name']+'_run_'+str(args.batch_size_run)+'_buffer_'+str(args.buffer_size)+'_seed_'+str(args.seed)+'_serial'
